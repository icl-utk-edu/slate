...
if (not opts.dim):
    if (opts.quick):
        n        = ' --dim 100'
        tall     = ' --dim 100x50 --dim 60x50' # 2:1, 6:5
        wide     = ' --dim 50x100 --dim 50x60' # 1:2, 5:6
        mnk      = ' --dim 25x50x75'
        if (is_default_nb):
            opts.nb = '8'
    ...
    if (opts.xsmall):
        n       += ' --dim 10'
        tall    += ' --dim 20x10 --dim 12x10'  # 2:1, 6:5
        wide    += ' --dim 10x20 --dim 10x12'  # 1:2, 5:6
    ...
    if (opts.small):
        n       += ' --dim 25:100:25'
        tall    += ' --dim 50:200:50x25:100:25' \
                +  ' --dim 60:240:60x50:200:50'             # 2:1, 6:5
        wide    += ' --dim 25:100:25x50:200:50' \
                +  ' --dim 50:200:50x60:240:60'             # 1:2, 5:6
    ...
    if (opts.medium):
        n       += ' --dim 100:500:100'
        tall    += ' --dim 200:1000:200x100:500:100' \
                +  ' --dim 120:600:120x100:500:100'         # 2:1, 6:5
        wide    += ' --dim 100:500:100x200:1000:200' \
                +  ' --dim 100:500:100x120:600:120'         # 1:2, 5:6
    ...
    if (opts.large):
        ...
        tall    += ' --dim 2000:10000:2000x1000:5000:1000' \
                +  ' --dim 1200:6000:1200x1000:5000:1000'   # 2:1, 6:5
        wide    += ' --dim 1000:5000:1000x2000:10000:2000' \
                +  ' --dim 1000:5000:1000x1200:6000:1200'   # 1:2, 5:6
