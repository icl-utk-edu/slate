...
Params::Params():
    ...
    dev_dist  ("dev-dist",9,    ParamType::List, slate::Dist::Col,        str2dist,     dist2str,   "matrix distribution across local devices (one-dimensional block-cyclic): col=column, row=row"),
