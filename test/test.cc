...
Params::Params():
    ...
    ortho      ("orth. error",           9, 2, ParamType::Output, testsweeper::no_data_flag,   0,   0, "orthogonality error"),
    ...
    error_sigma("Sigma error",           9, 2, ParamType::Output, testsweeper::no_data_flag,   0,   0, "Sigma error"),

    time      ("SLATE\ntime (s)",       10, 4, ParamType::Output, testsweeper::no_data_flag,   0,   0, "time to solution"),
    gflops    ("SLATE\nGflop/s",        10, 3, ParamType::Output, testsweeper::no_data_flag,   0,   0, "Gflop/s rate"),
    ...
    ref_gflops("Ref.\nGflop/s",         10, 3, ParamType::Output, testsweeper::no_data_flag,   0,   0, "reference Gflop/s rate"),
