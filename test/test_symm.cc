...
void test_symm_work(Params& params, bool run)
{
    ...
    if (origin != slate::Origin::ScaLAPACK) {
        ...
        A = slate::SymmetricMatrix<scalar_t>(uplo, An, nb, nprow, npcol, MPI_COMM_WORLD);
        ...
        A = slate::SymmetricMatrix<scalar_t>::fromScaLAPACK(uplo, An, &A_tst[0], lldA, nb, nprow, npcol, MPI_COMM_WORLD);
