...
void test_trcon_work(Params& params, bool run)
{
...
void test_trcon(Params& params, bool run)
{
    switch (params.datatype()) {
        ...
        case testsweeper::DataType::Single:
            test_trcon_work<float> (params, run);
            break;

        case testsweeper::DataType::Double:
            test_trcon_work<double> (params, run);
            break;

        case testsweeper::DataType::SingleComplex:
            test_trcon_work<std::complex<float>> (params, run);
            break;

        case testsweeper::DataType::DoubleComplex:
            test_trcon_work<std::complex<double>> (params, run);
            break;
    }
}
