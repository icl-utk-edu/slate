...
int main (int argc, char *argv[])
{
    ...
    switch (datatype) {
        case 's':
            test_trsm< float >( side, uplo, opA, opB, diag, m, n, nb, p, q, lookahead, target, test, verbose, trace );
            break;
        case 'd':
            test_trsm< double >( side, uplo, opA, opB, diag, m, n, nb, p, q, lookahead, target, test, verbose, trace );
            break;
        case 'c':
            test_trsm< std::complex<float> >( side, uplo, opA, opB, diag, m, n, nb, p, q, lookahead, target, test, verbose, trace );
            break;
        case 'z':
            test_trsm< std::complex<double> >( side, uplo, opA, opB, diag, m, n, nb, p, q, lookahead, target, test, verbose, trace );
            break;
        default:
